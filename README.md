...
**this forked library fix [this issue](https://github.com/sendgrid/sendgrid-nodejs/pull/619) in fix/typecsript-definistions branch and publish to @canner/sendgird**
